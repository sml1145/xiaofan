...
public class Camera1Session implements CameraSession {
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.Camera1Session$$ExternalSyntheticLambda0
            ...
            public final void onFrame(VideoFrame videoFrame) {
                Camera1Session.this.m2016lambda$listenForTextureFrames$0$orgwebrtcCamera1Session(videoFrame);
            }
        });
    }
    ...
    public /* synthetic */ void m2016lambda$listenForTextureFrames$0$orgwebrtcCamera1Session(VideoFrame frame) {
        checkIsOnCameraThread();
    ...
    public class AnonymousClass2 implements Camera.PreviewCallback {
            ...
            if (callbackCamera != Camera1Session.this.camera) {
                ...
                VideoFrame.Buffer frameBuffer = new NV21Buffer(data, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new Runnable() { // from class: org.webrtc.Camera1Session$2$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        Camera1Session.AnonymousClass2.this.m2018lambda$onPreviewFrame$1$orgwebrtcCamera1Session$2(data);
                    }
                });
        ...
        public /* synthetic */ void m2018lambda$onPreviewFrame$1$orgwebrtcCamera1Session$2(final byte[] data) {
            Camera1Session.this.cameraThreadHandler.post(new Runnable() { // from class: org.webrtc.Camera1Session$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera1Session.AnonymousClass2.this.m2017lambda$onPreviewFrame$0$orgwebrtcCamera1Session$2(data);
                }
            });
        }
        ...
        public /* synthetic */ void m2017lambda$onPreviewFrame$0$orgwebrtcCamera1Session$2(byte[] data) {
