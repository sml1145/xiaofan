...
public class VideoSource extends MediaSource {
            ...
            if (newVideoProcessor != null) {
                newVideoProcessor.setSink(new VideoSink() { // from class: org.webrtc.VideoSource$$ExternalSyntheticLambda1
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        VideoSource.this.m2172lambda$setVideoProcessor$1$orgwebrtcVideoSource(videoFrame);
                    }
                });
                if (this.isCapturerRunning) {
    ...
    public /* synthetic */ void m2171lambda$setVideoProcessor$0$orgwebrtcVideoSource(VideoFrame frame) {
    ...
    public /* synthetic */ void m2172lambda$setVideoProcessor$1$orgwebrtcVideoSource(final VideoFrame frame) {
        runWithReference(new Runnable() { // from class: org.webrtc.VideoSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                VideoSource.this.m2171lambda$setVideoProcessor$0$orgwebrtcVideoSource(frame);
            }
        });
    }
