...
public class HardwareVideoEncoder implements VideoEncoder {
            ...
            if (isKeyFrame && this.configBuffer != null) {
                ...
                releaseCallback = new Runnable() { // from class: org.webrtc.HardwareVideoEncoder$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        HardwareVideoEncoder.this.m2102lambda$deliverEncodedImage$0$orgwebrtcHardwareVideoEncoder(index);
                    }
                };
            }
    ...
    public /* synthetic */ void m2102lambda$deliverEncodedImage$0$orgwebrtcHardwareVideoEncoder(int index) {
        try {
            this.codec.releaseOutputBuffer(index, false);
        } catch (Exception e) {
