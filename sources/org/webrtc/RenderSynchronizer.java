...
public final class RenderSynchronizer {
    ...
    public RenderSynchronizer(float targetFrameRateFps) {
        ...
        this.mainThreadHandler.post(new Runnable() { // from class: org.webrtc.RenderSynchronizer$$ExternalSyntheticLambda2
            ...
            public final void run() {
                RenderSynchronizer.this.m2131lambda$new$0$orgwebrtcRenderSynchronizer();
            }
        });
    ...
    public /* synthetic */ void m2131lambda$new$0$orgwebrtcRenderSynchronizer() {
        ...
        synchronized (this.lock) {
            if (!this.isListening) {
                ...
                this.mainThreadHandler.post(new Runnable() { // from class: org.webrtc.RenderSynchronizer$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        RenderSynchronizer.this.m2132lambda$registerListener$1$orgwebrtcRenderSynchronizer();
                    }
                });
            }
        }
    ...
    public /* synthetic */ void m2132lambda$registerListener$1$orgwebrtcRenderSynchronizer() {
