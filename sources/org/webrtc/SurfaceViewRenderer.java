...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public void onFrameResolutionChanged(int videoWidth, int videoHeight, int rotation) {
        ...
        postOrRun(new Runnable() { // from class: org.webrtc.SurfaceViewRenderer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SurfaceViewRenderer.this.m2155lambda$onFrameResolutionChanged$0$orgwebrtcSurfaceViewRenderer(rotatedWidth, rotatedHeight);
            }
        });
    }
    ...
    public /* synthetic */ void m2155lambda$onFrameResolutionChanged$0$orgwebrtcSurfaceViewRenderer(int rotatedWidth, int rotatedHeight) {
