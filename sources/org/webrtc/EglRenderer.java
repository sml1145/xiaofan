...
public class EglRenderer implements VideoSink {
        ...
        synchronized (this.threadLock) {
            ...
            this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    EglRenderer.this.m2094lambda$release$0$orgwebrtcEglRenderer(eglCleanupBarrier);
                }
            });
    ...
    public /* synthetic */ void m2094lambda$release$0$orgwebrtcEglRenderer(CountDownLatch eglCleanupBarrier) {
    ...
    public void addFrameListener(final FrameListener listener, final float scale, final RendererCommon.GlDrawer drawerParam, final boolean applyFpsReduction) {
        postToRenderThread(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                EglRenderer.this.m2092lambda$addFrameListener$1$orgwebrtcEglRenderer(drawerParam, listener, scale, applyFpsReduction);
            }
        });
    }
    ...
    public /* synthetic */ void m2092lambda$addFrameListener$1$orgwebrtcEglRenderer(RendererCommon.GlDrawer drawerParam, FrameListener listener, float scale, boolean applyFpsReduction) {
    ...
    public void removeFrameListener(final FrameListener listener) {
        ...
        synchronized (this.threadLock) {
            ...
            postToRenderThread(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    EglRenderer.this.m2096lambda$removeFrameListener$2$orgwebrtcEglRenderer(latch, listener);
                }
            });
    ...
    public /* synthetic */ void m2096lambda$removeFrameListener$2$orgwebrtcEglRenderer(CountDownLatch latch, FrameListener listener) {
        latch.countDown();
        ...
        synchronized (this.threadLock) {
            if (this.eglThread != null) {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        EglRenderer.this.m2095lambda$releaseEglSurface$3$orgwebrtcEglRenderer(completionCallback);
                    }
                });
                return;
            }
    ...
    public /* synthetic */ void m2095lambda$releaseEglSurface$3$orgwebrtcEglRenderer(Runnable completionCallback) {
        if (this.eglBase != null) {
            this.eglBase.detachCurrent();
    ...
    public void m2093lambda$clearImage$4$orgwebrtcEglRenderer(float r, float g, float b, float a) {
    ...
    public void clearImage(final float r, final float g, final float b, final float a) {
        synchronized (this.threadLock) {
            ...
            this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    EglRenderer.this.m2093lambda$clearImage$4$orgwebrtcEglRenderer(r, g, b, a);
                }
            });
        }
    }
            ...
            if (this.eglThread != null) {
                this.eglThread.scheduleRenderUpdate(new EglThread.RenderUpdate() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda2
                    ...
                    public final void update(boolean z) {
                        EglRenderer.this.m2097lambda$swapBuffersOnRenderThread$5$orgwebrtcEglRenderer(frame, swapBuffersStartTimeNs, z);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void m2097lambda$swapBuffersOnRenderThread$5$orgwebrtcEglRenderer(VideoFrame frame, long swapBuffersStartTimeNs, boolean runsInline) {
        if (!runsInline) {
            if (this.eglBase == null || !this.eglBase.hasSurface()) {
                return;
            }
