...
public class HardwareVideoEncoderWrapper implements VideoEncoder {
    ...
    public VideoCodecStatus initEncode(final VideoEncoder.Settings originalSettings, final VideoEncoder.Callback callback) {
        ...
        try {
            ...
            if (result == VideoCodecStatus.FALLBACK_SOFTWARE) {
                ...
                return retryWithoutCropping(originalSettings.width, originalSettings.height, new Runnable() { // from class: org.webrtc.HardwareVideoEncoderWrapper$$ExternalSyntheticLambda2
                    ...
                    public final void run() {
                        HardwareVideoEncoderWrapper.this.m2116lambda$initEncode$0$orgwebrtcHardwareVideoEncoderWrapper(originalSettings, callback);
                    }
                });
            }
            return result;
            ...
            return retryWithoutCropping(originalSettings.width, originalSettings.height, new Runnable() { // from class: org.webrtc.HardwareVideoEncoderWrapper$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    HardwareVideoEncoderWrapper.this.m2117lambda$initEncode$1$orgwebrtcHardwareVideoEncoderWrapper(originalSettings, callback);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m2116lambda$initEncode$0$orgwebrtcHardwareVideoEncoderWrapper(VideoEncoder.Settings originalSettings, VideoEncoder.Callback callback) {
    ...
    public /* synthetic */ void m2117lambda$initEncode$1$orgwebrtcHardwareVideoEncoderWrapper(VideoEncoder.Settings originalSettings, VideoEncoder.Callback callback) {
        this.internalEncoder.initEncode(originalSettings, callback);
    }
            ...
            try {
                ...
                if (result == VideoCodecStatus.FALLBACK_SOFTWARE) {
                    ...
                    return retryWithoutCropping(frame.getBuffer().getWidth(), frame.getBuffer().getHeight(), new Runnable() { // from class: org.webrtc.HardwareVideoEncoderWrapper$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            HardwareVideoEncoderWrapper.this.m2114lambda$encode$2$orgwebrtcHardwareVideoEncoderWrapper(frame, encodeInfo);
                        }
                    });
                }
                return result;
                ...
                return retryWithoutCropping(frame.getBuffer().getWidth(), frame.getBuffer().getHeight(), new Runnable() { // from class: org.webrtc.HardwareVideoEncoderWrapper$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        HardwareVideoEncoderWrapper.this.m2115lambda$encode$3$orgwebrtcHardwareVideoEncoderWrapper(frame, encodeInfo);
                    }
                });
            } finally {
    ...
    public /* synthetic */ void m2114lambda$encode$2$orgwebrtcHardwareVideoEncoderWrapper(VideoFrame frame, VideoEncoder.EncodeInfo encodeInfo) {
    ...
    public /* synthetic */ void m2115lambda$encode$3$orgwebrtcHardwareVideoEncoderWrapper(VideoFrame frame, VideoEncoder.EncodeInfo encodeInfo) {
        this.internalEncoder.encode(frame, encodeInfo);
    }
