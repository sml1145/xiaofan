...
public class SurfaceTextureHelper {
        ...
        try {
            ...
            this.surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda5
                ...
                public final void onFrameAvailable(SurfaceTexture surfaceTexture) {
                    SurfaceTextureHelper.this.m2162lambda$new$0$orgwebrtcSurfaceTextureHelper(surfaceTexture);
                }
            }, handler);
        } catch (RuntimeException e) {
    ...
    public /* synthetic */ void m2162lambda$new$0$orgwebrtcSurfaceTextureHelper(SurfaceTexture st) {
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda3
            ...
            public final void run() {
                SurfaceTextureHelper.this.m2166lambda$stopListening$1$orgwebrtcSurfaceTextureHelper();
            }
        });
    }
    ...
    public /* synthetic */ void m2166lambda$stopListening$1$orgwebrtcSurfaceTextureHelper() {
        this.listener = null;
    ...
    public void setTextureSize(final int textureWidth, final int textureHeight) {
        ...
        this.handler.post(new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.m2165lambda$setTextureSize$2$orgwebrtcSurfaceTextureHelper(textureWidth, textureHeight);
            }
        });
    }
    ...
    public /* synthetic */ void m2165lambda$setTextureSize$2$orgwebrtcSurfaceTextureHelper(int textureWidth, int textureHeight) {
    ...
    public void forceFrame() {
        this.handler.post(new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.m2161lambda$forceFrame$3$orgwebrtcSurfaceTextureHelper();
            }
        });
    }
    ...
    public /* synthetic */ void m2161lambda$forceFrame$3$orgwebrtcSurfaceTextureHelper() {
        this.hasPendingTexture = true;
        tryDeliverTextureFrame();
    }
    ...
    public /* synthetic */ void m2164lambda$setFrameRotation$4$orgwebrtcSurfaceTextureHelper(int rotation) {
    ...
    public void setFrameRotation(final int rotation) {
        this.handler.post(new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.m2164lambda$setFrameRotation$4$orgwebrtcSurfaceTextureHelper(rotation);
            }
        });
    }
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.m2163lambda$returnTextureFrame$5$orgwebrtcSurfaceTextureHelper();
            }
        });
    }
    ...
    public /* synthetic */ void m2163lambda$returnTextureFrame$5$orgwebrtcSurfaceTextureHelper() {
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: org.webrtc.SurfaceTextureHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceTextureHelper.this.m2160lambda$dispose$6$orgwebrtcSurfaceTextureHelper();
            }
        });
    }
    ...
    public /* synthetic */ void m2160lambda$dispose$6$orgwebrtcSurfaceTextureHelper() {
