...
public class BaseActivity extends Activity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        UpdateManager.INSTANCE.resumePendingInstall(this);
    }
