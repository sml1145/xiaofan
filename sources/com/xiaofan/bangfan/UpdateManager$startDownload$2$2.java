...
public final class UpdateManager$startDownload$2$2 extends Lambda implements Function2<Long, Long, Unit> {
    final /* synthetic */ ProgressBar $bar;
    final /* synthetic */ TextView $pct;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UpdateManager$startDownload$2$2(ProgressBar progressBar, TextView textView) {
        super(2);
    ...
    public final void invoke(final long done, final long total) {
        ...
        handler.post(new Runnable() { // from class: com.xiaofan.bangfan.UpdateManager$startDownload$2$2$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                UpdateManager$startDownload$2$2.invoke$lambda$0(progressBar, p, textView, done, total);
            }
        });
    }
