...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    public /* synthetic */ void m37lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public /* synthetic */ void m38lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attrs) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda2
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m37lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m38lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
