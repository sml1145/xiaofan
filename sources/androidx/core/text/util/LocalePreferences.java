...
public final class LocalePreferences {
    ...
    public static class Api33Impl {
        static String getResolvedTemperatureUnit(Locale locale) {
            LocalizedNumberFormatter nf = ((UnlocalizedNumberFormatter) ((UnlocalizedNumberFormatter) NumberFormatter.with().usage(XiaoFanBrain.INTENT_WEATHER)).unit(MeasureUnit.CELSIUS)).locale(locale);
