...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1856deprecated_directory() {
        return this.cache.getDirectory();
    }
        ...
        public Entry(Source rawSource) throws IOException {
            ...
            try {
                ...
                if (isHttps()) {
                    ...
                    TlsVersion tlsVersion = !source3.exhausted() ? TlsVersion.Companion.forJavaName(source3.readUtf8LineStrict()) : TlsVersion.SSL_3_0;
        ...
        private final List<Certificate> readCertificateList(BufferedSource source) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    ByteString certificateBytes = ByteString.Companion.decodeBase64(line);
