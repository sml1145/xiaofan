...
public final class ExchangeFinder {
    ...
    public final ExchangeCodec find(OkHttpClient client, RealInterceptorChain chain) {
        ...
        try {
            RealConnection resultConnection = findHealthyConnection(chain.getConnectTimeoutMillis$okhttp(), chain.getReadTimeoutMillis$okhttp(), chain.getWriteTimeoutMillis$okhttp(), client.pingIntervalMillis(), client.retryOnConnectionFailure(), !Intrinsics.areEqual(chain.getRequest$okhttp().method(), "GET"));
