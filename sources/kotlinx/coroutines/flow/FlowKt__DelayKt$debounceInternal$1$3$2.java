...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1796invokeWpGqRn0(channelResult.m1781unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1796invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m1769boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m1781unboximpl = ((ChannelResult) this.L$0).m1781unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m1781unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m1781unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m1781unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m1773exceptionOrNullimpl(m1781unboximpl);
                    if (it != null) {
                        throw it;
                    }
