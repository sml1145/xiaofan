...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1793catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1804catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1794debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1797debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m1795sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m1798sampleHG0u8IE(flow, period);
    }
    ...
    public static final <T> Flow<T> m1796timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m1799timeoutHG0u8IE(flow, timeout);
    }
