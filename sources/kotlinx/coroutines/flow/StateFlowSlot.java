...
public final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
        ...
        while (true) {
            ...
            if (state == symbol2) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, state, symbol4)) {
                    ...
                    ((CancellableContinuationImpl) state).resumeWith(Result.m267constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && (!(_state$FU.get(this) instanceof CancellableContinuationImpl)) == 0) {
            throw new AssertionError();
        }
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = _state$FU;
        symbol = StateFlowKt.NONE;
