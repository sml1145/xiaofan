...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1798debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1753toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1753toDelayMillisLRDsOJo(function1.invoke(t).m1643unboximpl()));
            }
        });
    }
    ...
    public static final <T> Flow<T> m1799sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1753toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE */
    public static final <T> Flow<T> m1800timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m1801timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt */
    private static final <T> Flow<T> m1801timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
