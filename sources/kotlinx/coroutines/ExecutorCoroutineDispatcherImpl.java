...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1834dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo1834dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* renamed from: scheduleResumeAfterDelay */
    public void mo1835scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> cancellableContinuation) {
        Executor executor = getExecutor();
        ...
        if (future != null) {
            ...
            DefaultExecutor.INSTANCE.mo1835scheduleResumeAfterDelay(timeMillis, cancellableContinuation);
        }
    }
