...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V put(K k, V v) {
        Object obj;
        Object oldValue = (V) Core.putImpl$default((Core) core$FU.get(this), k, v, null, 4, null);
    ...
    public V remove(Object key) {
        ...
        Object oldValue = (V) Core.putImpl$default((Core) core$FU.get(this), key, null, null, 4, null);
        obj = ConcurrentWeakMapKt.REHASH;
        if (oldValue == obj) {
    ...
    public final class Core {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:34:0x007b, code lost:
            if (kotlinx.coroutines.channels.ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(r12.values, r0, r1, r14) == false) goto L19;
         */
            ...
            while (true) {
                ...
                for (int index = 0; index < i; index++) {
                    ...
                    while (true) {
                        ...
                        if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, index, value, mark)) {
                            break;
                        }
                    }
                ...
                while (true) {
                    ...
                    if (this.index < ((Core) Core.this).allocated) {
                        ...
                        if (hashedWeakRef != null && (k = (K) hashedWeakRef.get()) != null) {
                            this.key = k;
                            Object value = (V) ((Core) Core.this).values.get(this.index);
                            if (value instanceof Marked) {
