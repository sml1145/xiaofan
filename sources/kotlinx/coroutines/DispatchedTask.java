            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        if (DebugKt.getRECOVER_STACK_TRACES()) {
                            try {
                                if (continuation instanceof CoroutineStackFrame) {
                                    ...
                                    continuation.resumeWith(Result.m256constructorimpl(ResultKt.createFailure(cancellationException)));
                                }
                            } catch (Throwable th2) {
                                th = th2;
                        ...
                        continuation.resumeWith(Result.m256constructorimpl(ResultKt.createFailure(exception)));
                    } else {
                        Result.Companion companion3 = Result.Companion;
                        continuation.resumeWith(Result.m256constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m256constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.Companion;
                        result = Result.m256constructorimpl(ResultKt.createFailure(th));
                        handleFatalException$kotlinx_coroutines_core(fatalException, Result.m259exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
