            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m275constructorimpl(ResultKt.createFailure(exception)));
                    } else {
                        Result.Companion companion3 = Result.Companion;
                        continuation.resumeWith(Result.m275constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m275constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.Companion;
                        result = Result.m275constructorimpl(ResultKt.createFailure(th));
                        handleFatalException$kotlinx_coroutines_core(fatalException, Result.m278exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
