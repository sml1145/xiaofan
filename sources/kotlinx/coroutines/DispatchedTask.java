            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m273constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m273constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.Companion;
                        result = Result.m273constructorimpl(ResultKt.createFailure(th));
                        handleFatalException$kotlinx_coroutines_core(fatalException, Result.m276exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
