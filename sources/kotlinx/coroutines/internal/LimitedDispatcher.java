...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo1833scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo1833scheduleResumeAfterDelay(j, cancellableContinuation);
    }
    ...
    public void mo1832dispatch(CoroutineContext context, Runnable block) {
        ...
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo1832dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo1832dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
