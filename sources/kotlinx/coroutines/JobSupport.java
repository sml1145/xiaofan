...
public class JobSupport implements Job, ChildJob, ParentJob {
                ...
                if (list == null) {
                    ...
                    if (onCancelling && (state instanceof Finishing)) {
                        synchronized (state) {
                            ...
                            if (rootCause != null) {
                                if ((function1 instanceof ChildHandleNode) && !((Finishing) state).isCompleting()) {
                                }
                                Unit unit = Unit.INSTANCE;
                            }
    ...
    public final void registerSelectForOnJoin(SelectInstance<?> selectInstance, Object ignoredParam) {
        ...
        CompletionHandlerBase $this$asHandler$iv = new SelectOnJoinCompletionHandler(selectInstance);
    ...
    public final void onAwaitInternalRegFunc(SelectInstance<?> selectInstance, Object ignoredParam) {
        ...
        CompletionHandlerBase $this$asHandler$iv = new SelectOnAwaitCompletionHandler(selectInstance);
        DisposableHandle disposableHandle = invokeOnCompletion($this$asHandler$iv);
        selectInstance.disposeOnCompletion(disposableHandle);
    }
