...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo1770tryReceivePtdJZtk();
            if (ChannelResult.m1785isSuccessimpl(result)) {
                return (E) ChannelResult.m1781getOrThrowimpl(result);
            }
            Throwable m1779exceptionOrNullimpl = ChannelResult.m1779exceptionOrNullimpl(result);
            if (m1779exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1779exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L2d:
                ...
                java.lang.Object r3 = r3.m1787unboximpl()
                goto L45
            L38:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1769receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1780getOrNullimpl(r3)
                return r3
            */
