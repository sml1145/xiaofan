...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo1780receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1778receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            $this$resumeWithStackTrace$iv.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            $this$resumeWithStackTrace$iv2.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(th)));
        }
                    ...
                    try {
                        switch (updateCellSend(channelSegment, index, e, s, cancellable$iv, false)) {
                            case 0:
                                ...
                                Result.Companion companion = Result.Companion;
                                cancellable$iv.resumeWith(Result.m273constructorimpl(Unit.INSTANCE));
                                break;
                            case 1:
                                Result.Companion companion2 = Result.Companion;
                                cancellable$iv.resumeWith(Result.m273constructorimpl(Unit.INSTANCE));
    ...
    public final void onClosedSendOnNoWaiterSuspend(E e, CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        Result.Companion companion = Result.Companion;
        cancellableContinuation2.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(exception$iv)));
    }
        ...
        while (true) {
            ...
            if (segment$iv3.id != id$iv) {
                ...
                if (segment$iv4 != null) {
                    ...
                    return ChannelResult.Companion.m1799closedJP2dKIU(getSendException());
                }
            } else {
                segment$iv = segment$iv3;
            }
        ...
        while (true) {
            ...
            if (segment$iv2.id != id$iv) {
                ...
                if (segment$iv3 != null) {
                    ...
                    Result.Companion companion = Result.Companion;
                    cont.resumeWith(Result.m273constructorimpl(Boxing.boxBoolean(false)));
                } else {
            ...
            switch (bufferedChannel.updateCellSend(segment$iv, i$iv, e, $this$sendersCounter$iv$iv, waiter$iv, closed$iv)) {
                case 0:
                    segment$iv.cleanPrev();
                    Result.Companion companion2 = Result.Companion;
                    cont.resumeWith(Result.m273constructorimpl(Boxing.boxBoolean(true)));
                    break;
                case 1:
                    Result.Companion companion3 = Result.Companion;
                    cont.resumeWith(Result.m273constructorimpl(Boxing.boxBoolean(true)));
    ...
    private final boolean tryResumeReceiver(Object $this$tryResumeReceiver, E e) {
        ...
        if ($this$tryResumeReceiver instanceof ReceiveCatching) {
            ...
            ChannelResult m1786boximpl = ChannelResult.m1786boximpl(ChannelResult.Companion.m1801successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m1786boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, ((ReceiveCatching) $this$tryResumeReceiver).cont.getContext()) : null);
            return tryResume02;
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    public static /* synthetic */ <E> java.lang.Object m1778receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r17, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r18) {
        /*
            Method dump skipped, instructions count: 240
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1778receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m1779receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r28, int r29, long r30, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r32) {
        /*
            Method dump skipped, instructions count: 444
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1779receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cancellableContinuation) {
        Result.Companion companion = Result.Companion;
        cancellableContinuation.resumeWith(Result.m273constructorimpl(ChannelResult.m1786boximpl(ChannelResult.Companion.m1799closedJP2dKIU(getCloseCause()))));
    }
    ...
    public Object mo1781tryReceivePtdJZtk() {
        ...
        if (isClosedForReceive0(sendersAndCloseStatusCur)) {
            return ChannelResult.Companion.m1799closedJP2dKIU(getCloseCause());
        }
        long $this$sendersCounter$iv = sendersAndCloseStatusCur & 1152921504606846975L;
        ...
        while (!isClosedForReceive()) {
            ...
            if (updCellResult$iv != symbol) {
                ...
                if (updCellResult$iv != symbol2) {
                    ...
                    segment$iv4.cleanPrev();
                    return ChannelResult.Companion.m1801successJP2dKIU(updCellResult$iv);
                }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1786boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.Companion.m1799closedJP2dKIU(getCloseCause()) : ChannelResult.Companion.m1801successJP2dKIU(selectResult));
    }
    ...
    public final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (cause == null) {
                Result.Companion companion = Result.Companion;
                cont.resumeWith(Result.m273constructorimpl(false));
                return;
            }
            ...
            Result.Companion companion2 = Result.Companion;
            cancellableContinuationImpl.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(th)));
        }
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> channelSegment, long sendersCounter) {
        Symbol symbol;
        Object suspendedReceivers = InlineList.m1823constructorimpl$default(null, 1, null);
                        ...
                        if (state != symbol) {
                            if (state instanceof WaiterEB) {
                                if (segment.casState$kotlinx_coroutines_core(index, state, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    suspendedReceivers = InlineList.m1828plusFjFbRPM(suspendedReceivers, ((WaiterEB) state).waiter);
                                ...
                                suspendedReceivers = InlineList.m1828plusFjFbRPM(suspendedReceivers, state);
                                segment.onCancelledRequest(index, true);
                                break;
                            }
                        }
    ...
    private final void resumeWaiterOnClosedChannel(Waiter $this$resumeWaiterOnClosedChannel, boolean receiver) {
        if (!($this$resumeWaiterOnClosedChannel instanceof SendBroadcast)) {
            if (!($this$resumeWaiterOnClosedChannel instanceof CancellableContinuation)) {
                ...
                Result.Companion companion = Result.Companion;
                ((ReceiveCatching) $this$resumeWaiterOnClosedChannel).cont.resumeWith(Result.m273constructorimpl(ChannelResult.m1786boximpl(ChannelResult.Companion.m1799closedJP2dKIU(getCloseCause()))));
                return;
            }
            Continuation continuation = (Continuation) $this$resumeWaiterOnClosedChannel;
            Result.Companion companion2 = Result.Companion;
            continuation.resumeWith(Result.m273constructorimpl(ResultKt.createFailure(receiver ? getReceiveException() : getSendException())));
            return;
        }
        Result.Companion companion3 = Result.Companion;
        ((SendBroadcast) $this$resumeWaiterOnClosedChannel).getCont().resumeWith(Result.m273constructorimpl(false));
    }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> channelSegment) {
        ...
        while (true) {
            ...
            if (SegmentOrClosed.m1840isClosedimpl(s$iv)) {
                break;
            }
            Segment to$iv$iv = SegmentOrClosed.m1838getSegmentimpl(s$iv);
            while (true) {
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m1838getSegmentimpl(s$iv);
        if (segment.id > id) {
    ...
    public final ChannelSegment<E> findSegmentReceive(long id, ChannelSegment<E> channelSegment) {
        ...
        Object it = s$iv;
        if (SegmentOrClosed.m1840isClosedimpl(it)) {
            completeCloseOrCancel();
        ...
        ChannelSegment segment = (ChannelSegment) SegmentOrClosed.m1838getSegmentimpl(it);
