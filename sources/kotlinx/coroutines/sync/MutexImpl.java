...
public class MutexImpl extends SemaphoreImpl implements Mutex {
    ...
    public MutexImpl(boolean locked) {
        super(1, locked ? 1 : 0);
        this.owner = locked ? null : MutexKt.NO_OWNER;
    ...
    public final class CancellableContinuationWithOwner implements CancellableContinuation<Unit>, Waiter {
        ...
        public Object tryResume2(Unit value, Object idempotent, Function1<? super Throwable, Unit> function1) {
            Symbol symbol;
            Symbol symbol2;
        ...
        public void resume2(Unit value, Function1<? super Throwable, Unit> function1) {
            Symbol symbol;
            MutexImpl mutexImpl = MutexImpl.this;
            if (DebugKt.getASSERTIONS_ENABLED()) {
                Object obj = MutexImpl.owner$FU.get(mutexImpl);
