...
public final class UHexExtensionsKt {
    ...
    private static final String m1566toHexStringzHuV2wU(byte[] toHexString, HexFormat format) {
    ...
    static /* synthetic */ String m1567toHexStringzHuV2wU$default(byte[] toHexString, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    static /* synthetic */ String m1563toHexStringlZCiFrA$default(byte[] toHexString, int startIndex, int endIndex, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            startIndex = 0;
        }
        if ((i & 2) != 0) {
            endIndex = UByteArray.m333getSizeimpl(toHexString);
        }
        if ((i & 4) != 0) {
            format = HexFormat.Companion.getDefault();
        }
    ...
    private static final String m1562toHexStringlZCiFrA(byte[] toHexString, int startIndex, int endIndex, HexFormat format) {
        Intrinsics.checkNotNullParameter(toHexString, "$this$toHexString");
        Intrinsics.checkNotNullParameter(format, "format");
        return HexExtensionsKt.toHexString(toHexString, startIndex, endIndex, format);
    }
    ...
    static /* synthetic */ byte[] hexToUByteArray$default(String $this$hexToUByteArray_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByteArray.m327constructorimpl(HexExtensionsKt.hexToByteArray($this$hexToUByteArray_u24default, format));
    }
    ...
    private static final byte[] hexToUByteArray(String $this$hexToUByteArray, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByteArray.m327constructorimpl(HexExtensionsKt.hexToByteArray($this$hexToUByteArray, format));
    }

    /* renamed from: toHexString-ZQbaR00  reason: not valid java name */
    private static final String m1560toHexStringZQbaR00(byte $this$toHexString_u2dZQbaR00, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1561toHexStringZQbaR00$default(byte $this$toHexString_u2dZQbaR00_u24default, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            format = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final byte hexToUByte(String $this$hexToUByte, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByte.m274constructorimpl(HexExtensionsKt.hexToByte($this$hexToUByte, format));
    }
    ...
    static /* synthetic */ byte hexToUByte$default(String $this$hexToUByte_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UByte.m274constructorimpl(HexExtensionsKt.hexToByte($this$hexToUByte_u24default, format));
    }

    /* renamed from: toHexString-r3ox_E0  reason: not valid java name */
    private static final String m1564toHexStringr3ox_E0(short $this$toHexString_u2dr3ox_E0, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1565toHexStringr3ox_E0$default(short $this$toHexString_u2dr3ox_E0_u24default, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            format = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final short hexToUShort(String $this$hexToUShort, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UShort.m537constructorimpl(HexExtensionsKt.hexToShort($this$hexToUShort, format));
    }
    ...
    static /* synthetic */ short hexToUShort$default(String $this$hexToUShort_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UShort.m537constructorimpl(HexExtensionsKt.hexToShort($this$hexToUShort_u24default, format));
    }

    /* renamed from: toHexString-8M7LxHw  reason: not valid java name */
    private static final String m1556toHexString8M7LxHw(int $this$toHexString_u2d8M7LxHw, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1557toHexString8M7LxHw$default(int $this$toHexString_u2d8M7LxHw_u24default, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            format = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final int hexToUInt(String $this$hexToUInt, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UInt.m351constructorimpl(HexExtensionsKt.hexToInt($this$hexToUInt, format));
    }
    ...
    static /* synthetic */ int hexToUInt$default(String $this$hexToUInt_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return UInt.m351constructorimpl(HexExtensionsKt.hexToInt($this$hexToUInt_u24default, format));
    }

    /* renamed from: toHexString-8UJCm-I  reason: not valid java name */
    private static final String m1558toHexString8UJCmI(long $this$toHexString_u2d8UJCm_u2dI, HexFormat format) {
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    static /* synthetic */ String m1559toHexString8UJCmI$default(long $this$toHexString_u2d8UJCm_u2dI_u24default, HexFormat format, int i, Object obj) {
        if ((i & 1) != 0) {
            format = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(format, "format");
    ...
    private static final long hexToULong(String $this$hexToULong, HexFormat format) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return ULong.m430constructorimpl(HexExtensionsKt.hexToLong($this$hexToULong, format));
    }
    ...
    static /* synthetic */ long hexToULong$default(String $this$hexToULong_u24default, HexFormat format, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(format, "format");
        return ULong.m430constructorimpl(HexExtensionsKt.hexToLong($this$hexToULong_u24default, format));
    }
}
