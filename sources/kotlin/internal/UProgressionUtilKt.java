...
public final class UProgressionUtilKt {
    ...
    private static final int m1463differenceModuloWZ9TVnA(int a, int b, int c) {
        int compare;
        ...
        return UInt.m351constructorimpl(compare >= 0 ? ac - bc : UInt.m351constructorimpl(ac - bc) + c);
    }

    /* renamed from: differenceModulo-sambcqE  reason: not valid java name */
    private static final long m1464differenceModulosambcqE(long a, long b, long c) {
        int compare;
        ...
        return ULong.m430constructorimpl(compare >= 0 ? ac - bc : ULong.m430constructorimpl(ac - bc) + c);
    }

    /* renamed from: getProgressionLastElement-Nkh28Cs  reason: not valid java name */
    public static final int m1466getProgressionLastElementNkh28Cs(int start, int end, int step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Integer.compare(start ^ Integer.MIN_VALUE, end ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return UInt.m351constructorimpl(end - m1463differenceModuloWZ9TVnA(end, start, UInt.m351constructorimpl(step)));
            }
        } else if (step >= 0) {
            ...
            if (compare > 0) {
                return UInt.m351constructorimpl(m1463differenceModuloWZ9TVnA(start, end, UInt.m351constructorimpl(-step)) + end);
            }
        }
        return end;
    }
    ...
    public static final long m1465getProgressionLastElement7ftBX0g(long start, long end, long step) {
        int compare;
        int compare2;
        if (step > 0) {
            compare2 = Long.compare(start ^ Long.MIN_VALUE, end ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return ULong.m430constructorimpl(end - m1464differenceModulosambcqE(end, start, ULong.m430constructorimpl(step)));
            }
        } else if (step >= 0) {
            throw new IllegalArgumentException("Step is zero.");
        } else {
            ...
            if (compare > 0) {
                return ULong.m430constructorimpl(m1464differenceModulosambcqE(start, end, ULong.m430constructorimpl(-step)) + end);
            }
        }
        return end;
    }
