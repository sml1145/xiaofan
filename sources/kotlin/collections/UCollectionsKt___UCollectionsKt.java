...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] result = UByteArray.m337constructorimpl(collection.size());
        int index = 0;
        for (UByte uByte : collection) {
            byte element = uByte.m335unboximpl();
            UByteArray.m348setVurrAj0(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] result = UIntArray.m416constructorimpl(collection.size());
        int index = 0;
        for (UInt uInt : collection) {
            int element = uInt.m414unboximpl();
            UIntArray.m427setVXSXFK8(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] result = ULongArray.m495constructorimpl(collection.size());
        int index = 0;
        for (ULong uLong : collection) {
            long element = uLong.m493unboximpl();
            ULongArray.m506setk8EXiF4(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] result = UShortArray.m600constructorimpl(collection.size());
        int index = 0;
        for (UShort uShort : collection) {
            short element = uShort.m598unboximpl();
            UShortArray.m611set01HTLdE(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            int element = uInt.m414unboximpl();
            sum = UInt.m362constructorimpl(sum + element);
        }
        return sum;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            long element = uLong.m493unboximpl();
            sum = ULong.m441constructorimpl(sum + element);
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            byte element = uByte.m335unboximpl();
            sum = UInt.m362constructorimpl(UInt.m362constructorimpl(element & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            short element = uShort.m598unboximpl();
            sum = UInt.m362constructorimpl(UInt.m362constructorimpl(65535 & element) + sum);
        }
        return sum;
    }
}
