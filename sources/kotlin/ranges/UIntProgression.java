...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1483getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }

    /* renamed from: getFirst-pVg5ArA  reason: not valid java name */
    public final int m1497getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1498getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) UInt.m414toStringimpl(this.first)).append("..").append((Object) UInt.m414toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append((Object) UInt.m414toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m414toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1499fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
