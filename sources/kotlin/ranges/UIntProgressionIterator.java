...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r0 = kotlin.UInt.m365constructorimpl(r6)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m359boximpl(m1497nextpVg5ArA());
    }
    ...
    public int m1497nextpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m365constructorimpl(this.next + this.step);
        }
        return value;
    }
}
