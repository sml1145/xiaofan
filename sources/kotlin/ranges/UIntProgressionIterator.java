...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r0 = kotlin.UInt.m351constructorimpl(r6)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m345boximpl(m1483nextpVg5ArA());
    }
    ...
    public int m1483nextpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m351constructorimpl(this.next + this.step);
        }
        return value;
    }
}
