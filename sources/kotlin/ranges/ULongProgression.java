...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1479getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m444constructorimpl(this.first ^ ULong.m444constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m444constructorimpl(this.last ^ ULong.m444constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m490toStringimpl(this.first)).append("..").append((Object) ULong.m490toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m490toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m490toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1505fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
