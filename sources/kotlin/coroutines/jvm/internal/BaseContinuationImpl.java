    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                m270constructorimpl = Result.m270constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.Companion;
            m270constructorimpl = Result.m270constructorimpl(outcome);
            Object outcome2 = m270constructorimpl;
