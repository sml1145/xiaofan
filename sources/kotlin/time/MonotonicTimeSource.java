...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1727boximpl(m1721markNowz9LOYto());
    }
    ...
    public long m1721markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1730constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1720elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1719differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1718adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1730constructorimpl(LongSaturatedMathKt.m1716saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
