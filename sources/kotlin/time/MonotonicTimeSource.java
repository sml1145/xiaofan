...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1722boximpl(m1716markNowz9LOYto());
    }
    ...
    public long m1716markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1725constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1715elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1714differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1713adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1725constructorimpl(LongSaturatedMathKt.m1711saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
