...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1728boximpl(m1722markNowz9LOYto());
    }
    ...
    public long m1722markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1731constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1721elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1720differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m1719adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1731constructorimpl(LongSaturatedMathKt.m1717saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
