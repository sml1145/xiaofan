...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1577elapsedNowUwyO8pc() {
            return Duration.m1622minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark mo1580plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1623plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1579minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1592equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1619isInfiniteimpl(this.offset)) {
                return Duration.Companion.m1690getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1622minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1592equalsimpl0(startedAtDiff, Duration.m1640unaryMinusUwyO8pc(offsetDiff)) ? Duration.Companion.m1690getZEROUwyO8pc() : Duration.m1623plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1592equalsimpl0(mo1579minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m1690getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1615hashCodeimpl(Duration.m1623plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1636toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1690getZEROUwyO8pc(), null);
    }
}
