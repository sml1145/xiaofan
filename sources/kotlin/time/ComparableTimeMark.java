...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1584minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1585minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1586plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1588minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1586plusLRDsOJo(Duration.m1646unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1592compareToLRDsOJo($this.mo1585minusUwyO8pc(other), Duration.Companion.m1696getZEROUwyO8pc());
        }
    }
}
