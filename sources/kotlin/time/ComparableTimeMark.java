...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1587minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1588minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1589plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1591minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1589plusLRDsOJo(Duration.m1649unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1595compareToLRDsOJo($this.mo1588minusUwyO8pc(other), Duration.Companion.m1699getZEROUwyO8pc());
        }
    }
}
