...
public interface TimeMark {
    ...
    TimeMark mo1579minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1581plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1726plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1725minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1581plusLRDsOJo(Duration.m1641unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1621isNegativeimpl($this.mo1578elapsedNowUwyO8pc());
        }
