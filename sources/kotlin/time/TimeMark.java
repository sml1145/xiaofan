...
public interface TimeMark {
    ...
    TimeMark mo1592minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1594plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1739plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1738minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1594plusLRDsOJo(Duration.m1654unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1634isNegativeimpl($this.mo1591elapsedNowUwyO8pc());
        }
