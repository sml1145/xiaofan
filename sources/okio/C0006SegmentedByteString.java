...
public final class C0006SegmentedByteString extends ByteString {
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        int segmentOffset$iv = beginSegment$iv != 0 ? getDirectory$okio()[beginSegment$iv - 1] : 0;
        int length = newSegments$iv.length;
        newDirectory$iv[length] = newDirectory$iv[length] + (beginIndex - segmentOffset$iv);
        return new C0006SegmentedByteString(newSegments$iv, newDirectory$iv);
    }
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0006SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0006SegmentedByteString $this$commonWrite$iv2 = this;
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0006SegmentedByteString $this$commonRangeEquals$iv = this;
        if (offset >= 0 && offset <= $this$commonRangeEquals$iv.size() - byteCount) {
            ...
            while (pos$iv$iv < endIndex$iv$iv) {
                ...
                C0006SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0006SegmentedByteString $this$commonCopyInto$iv = this;
